...
export const managementPrograms: AppInfo[] = [
    {
        ...
        url: 'https://script.google.com/macros/s/AKfycbwAYIXOZzXTUtQxE0qRG5luAW5JRMIsS6IqYjyl6KtViHha6FQ5CvYx1O3_HQ-kj_vL/exec',
        icon: <PmsIcon />,
    ...
    },
    {
        ...
        url: 'https://script.google.com/macros/s/AKfycbyf18lU_NvJk_aibYhBoS6qde82vePENqT4ac9kCBdDkjfC4aOggW_WaaJ6-oLlfoe_/exec',
        icon: <CrmIcon />,
...
export const managementSystems: AppInfo[] = [
    {
        ...
        url: 'https://script.google.com/macros/s/AKfycbzGoSmSKjHBu0uTL6ox-oJo9r7dmTfzK4ncS5-VAZzvRxskiPOoT-MrbGZrOMUyHuQV/exec',
        icon: <AmsIcon />,
